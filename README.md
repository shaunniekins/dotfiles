...
| Status bar		| [Qtile](https://wiki.archlinux.org/title/Qtile)											|
...
| File Manager	| [Nemo](https://wiki.archlinux.org/title/Nemo), nemo-file-roller										|
| IDE'S			| [VSCode](https://wiki.archlinux.org/title/Visual_Studio_Code), [Neovim](https://neovim.io/)			|
